...
if __name__=="__main__":
    ...
    # run_dir1 = os.path.join(os.path.dirname(__file__), f'../../../results/run_results/clustering/plot_cluster-2023-11-30_18-40')
    # umap_csv = os.path.join(run_dir1, "RBD_variants_clustering_esm_blstm_umap_coordinates.csv")
    # tsne_csv = os.path.join(run_dir1, "RBD_variants_clustering_esm_blstm_tsne_coordinates.csv")
    # plot_from_embedding(umap_csv, 'UMAP')
    # plot_from_embedding(tsne_csv, 'tSNE')

    # run_dir2 = os.path.join(os.path.dirname(__file__), f'../../../results/run_results/clustering/plot_cluster-2023-11-30_16-44')
    # umap_list = [os.path.join(run_dir2, f"RBD_variants_clustering_esm_blstm_a22073_d21887_o22399_iter{i}_umap_coordinates.csv") for i in range(12)]
    # plot_12_embeddings(umap_list, 'UMAP')
    
    # tsne_list = [os.path.join(run_dir2, f"RBD_variants_clustering_esm_blstm_a22073_d21887_o22399_iter{i}_tsne_coordinates.csv") for i in range(12)]
